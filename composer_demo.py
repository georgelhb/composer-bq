...
BQ_DATASET_NAME = 'composer_dataset'
...
with DAG('composer_demo', default_args=default_args) as dag:
  ...
  t2 = GoogleCloudStorageToBigQueryOperator(
      ...
      destination_project_dataset_table='{0}.composer_data'
      .format(BQ_DATASET_NAME),
      schema_fields=[
          {
              'name': 'name',
  ...
  t3 = BigQueryOperator(
      ...
      bql="""
        ...
        LIMIT 100;
      """.format(BQ_DATASET_NAME),
      destination_dataset_table='{0}.composer_result'
      .format(BQ_DATASET_NAME),
      write_disposition='WRITE_TRUNCATE')
